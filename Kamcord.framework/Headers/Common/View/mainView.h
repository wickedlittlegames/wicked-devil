...
@interface MainView : KCViewController <KC_ShareMessageDelegate, KCShareDelegate, KCVideoDelegate, KCVideoProcessDelegate, UINavigationControllerDelegate, UIAlertViewDelegate>
