...
-(void)setType:(MKInfoPanelType)type {
    if(type == MKInfoPanelTypeError) {
        ...
        self.backgroundGradient.image = [[UIImage imageNamed:@"bg-topbar.png"] stretchableImageWithLeftCapWidth:1 topCapHeight:5];
        ...
        self.detailLabel.textColor = RGBA(0, 0, 0, 1.0);
        self.detailLabel.font = [UIFont fontWithName:@"CrashLanding BB"
                                                size:36];
    }
}
